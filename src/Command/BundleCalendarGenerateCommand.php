...
use Calendar\PdfRenderBundle\LandscapeMessageHandler;
...
class BundleCalendarGenerateCommand extends Command
{
    protected static $defaultName = 'bundle:calendar:generate';

    /** @var HolidaysRepository */
    protected $holidayRepo;

    public function __construct(HolidaysRepository $holidaysRepository, \Calendar\PdfRenderBundle\RenderRequest $arg)
    {
